   ...
   <Table striped>
    ...
    <tbody>
     <tr><td className="wd-full-name text-nowrap">
      ...
      <td className="wd-total-activity">13:32:43</td></tr>
      <tr><td className="wd-full-name text-nowrap">
          <FaUserCircle className="me-2 fs-1 text-secondary" />
          <span className="wd-first-name">Leo</span>{" "}
          <span className="wd-last-name">Das</span></td>
      <td className="wd-login-id">001234565S</td>
      <td className="wd-section">S101</td>
      <td className="wd-role">STUDENT</td>
      <td className="wd-last-activity">2020-11-03</td>
      <td className="wd-total-activity">11:22:52</td></tr>
