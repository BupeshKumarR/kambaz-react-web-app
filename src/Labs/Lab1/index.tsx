    ...
    <div id="wd-lab1">
      ...
      <h4>List Tags</h4>
        ...
        <ol id="wd-your-favorite-recipe">
          <li>Whisk together eggs, milk, vanilla, cinnamon, and salt in a shallow dish.</li>
          <li>Heat a non-stick skillet or griddle over medium heat.</li>
          <li>Melt a small amount of butter in the pan.</li>
          <li>Dip a slice of bread in the egg mixture, coating both sides evenly.</li>
          <li>Place the coated bread in the hot pan.</li>
          <li>Cook for 2-3 minutes on each side, until golden brown.</li>
          <li>Repeat with remaining slices, adding more butter to the pan as needed.</li>
      ...
      <h5>Unordered List Tag</h5>
        ...
        <div id="wd-images">
          ...
          <br />
          Loading an image from the local directory: <br />
        ...
        <h4>Anchor tag</h4>
          ...
          <a href="https://github.com/BupeshKumarR/kambaz-react-web-app.git" id="wd-github">Click here</a> for my GitHub repository <br/>
        </div>
